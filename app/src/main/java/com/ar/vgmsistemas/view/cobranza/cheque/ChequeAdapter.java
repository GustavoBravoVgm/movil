...
public class ChequeAdapter extends ListItemAdapter<Cheque> {

    public ChequeAdapter(Context context, List<Cheque> objects) {
        super(context, R.layout.lyt_cheques_item, objects);
    }
