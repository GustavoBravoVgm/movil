...
public class DevolucionDialogFragment extends BaseDialogFragment {
    public static final String EXTRA_VENTA_DETALLE = "extraVentaDetalle";
    private DevolucionListener mListener;
    ...
    public static DevolucionDialogFragment newInstance(VentaDetalle ventaDetalle, DevolucionListener listener) {
        Bundle bundle = new Bundle();
        bundle.putSerializable(EXTRA_VENTA_DETALLE, ventaDetalle);


        DevolucionDialogFragment devolucionDialogFragment = new DevolucionDialogFragment();
