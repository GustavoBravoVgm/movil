...
@DatabaseView(
        value = "SELECT MIN(prioridad) as prioridad, " +
                ...
                "       id_grupo_clie as id_grupo_clie, " +
                ...
                "       AND acciones_com.ti_origen = 'P'   ) t " +
                "GROUP BY id_grupo_clie,id_articulos", viewName = "v_accionesComMax_Prov"
)
//@Entity(tableName = "v_accionesComMax_Prov", primaryKeys = {"id_grupo_clie","id_articulos"})
public class AccionesComMaxProvViewBd {
